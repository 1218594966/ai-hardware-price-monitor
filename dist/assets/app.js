...
(() => {
  ...
  var SEED_QUOTATIONS = [
    ...
    },
    {
      ...
      items: [
        { name: "训练显卡", brand: "NVIDIA", model: "RTX 6000 Ada 48G", qty: 2, unit: "张", price: 58800, hist: [62e3, 60800, 59500, 58800] },
        ...
        { name: "内存", brand: "三星", model: "ECC DDR5 256GB（64GB×4）", qty: 1, unit: "组", price: 12999, hist: [8999, 10500, 12e3, 12999] },
